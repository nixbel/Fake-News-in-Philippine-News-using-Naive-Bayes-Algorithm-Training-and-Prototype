document.addEventListener('DOMContentLoaded', function() {
  ...
  const credibleList = document.getElementById('credibleWords');
  const suspiciousList = document.getElementById('suspiciousWords');
          ...
          chrome.tabs.sendMessage(activeTab.id, { action: "getText" }, function(response) {
              ...
              .then(data => {
                  ...
                  chrome.tabs.sendMessage(activeTab.id, {
                      ...
                      credibleWords: data.credible_words || [],
                      suspiciousWords: data.suspicious_words || []
                  });
